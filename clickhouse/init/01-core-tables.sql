...
CREATE TABLE IF NOT EXISTS receipts (
    ...
    block_timestamp           DateTime64(9, 'UTC') COMMENT 'The timestamp of the block in UTC',
    block_hash                String COMMENT 'The hash of the block',
    parent_transaction_hash   Nullable(String) COMMENT 'The parent transaction hash. NULL when the originating tx was on an account outside accounts_of_interest and BlocksAPI never delivered it (e.g. bridge deposits arriving via untracked intermediaries)',
